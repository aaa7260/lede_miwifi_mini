...
sed -i 's#PKG_SOURCE_URL:=https://github.com/freedesktop/poppler/archive/refs/tags/#PKG_SOURCE_URL:=https://gitlab.freedesktop.org/poppler/poppler-web-page/-/blob/master/#g' feeds/cups/poppler/Makefile
